...
const Utils = {
  ...
  genUUID() { // Public Domain/MIT
    var d = new Date().getTime();//Timestamp
    var d2 = 0; //((typeof performance !== 'undefined') && performance.now && (performance.now()*1000)) || 0;//Time in microseconds since page-load or 0 if unsupported
